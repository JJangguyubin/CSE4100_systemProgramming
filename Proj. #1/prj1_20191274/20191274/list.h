...
/*
    ...
    In sp_prj1_mylib, especially, in page 4,
    we can know that 'struct list_item' is not given in the source code, 
...
// ---.
// ,that is, list_entry macro : struct list_elem ==>> struct list_item.
// ---.
